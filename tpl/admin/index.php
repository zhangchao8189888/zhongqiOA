    ...
    <div class="container-fluid" >
        <div class="quick-actions_homepage">
            <ul class="quick-actions">
                <li class="bg_lb"> <a href="index.php?action=Order&mode=toOrderPage"> <i class="icon-off"></i> 订单</a> </li>
                <li class="bg_ly span3" > <a href="index.php?action=Customer&mode=getCustomerList"> <i class="icon-calendar"></i><span class="label label-success">10</span> 客户</a> </li>
        ...
        <div class="row-fluid">
            <div class="span6">
              ...
              <canvas width="50" height="24"></canvas>
                                ...
                                <div class="right"> <strong>5672</strong> 工长 </div>
                            </li>-->
                        </ul>
                    </div>
                </div>
        ...
        <div class="row-fluid" >
            <div class="span12">
                <div class="sheet__heading text-center"  >
                    <h1 class="giga text-heading-alt text-primary xs-margin-null xs-margin-bottom-small sm-margin-bottom-small md-margin-bottom-small">订单系统平台</h1>
