...
<script language="javascript" type="text/javascript">
    $(function(){
        ...
        $("#num_add").click(function(){
            $.ajax(
                {
                    type: "POST",
                    url: "index.php?action=Kucun&mode=addProNum",
                    ...
                    success: function(msg)
                    {
                        if (msg.code =='1000'){
                            if (confirm("保存成功，继续添加？")){
                                ...
                                location.href = "index.php?action=Kucun&mode=toProduceList";
                            }
                        }
                    }
                }
    ...
    function sortPro() {
        location.href = "index.php?action=Kucun&mode=toProduceList&proNo="
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="index.php?action=Kucun&mode=toProduceList" enctype="multipart/form-data" name="basic_validate" id="basic_validate" novalidate="novalidate">
                                    ...
                                    <span class="pull-left">
                                        ...
                                        <div class="controls">
                                            <select id="proSort" onchange="sortPro()" >
                                                ...
                                                <option value = "2" <?php if($order ==2) echo "selected" ?>>生成小计</option>
                            ...
                            <div class="form-actions">
                                <div class="control-group">
                                    ...
                                    <span class="pull-left">
                                        <label class="control-label">生产月份：</label>
                                        <div class="controls">
                                            ...
                                            <input type="submit" value="查询生成列表" class="btn btn-success"/>
                                        </div>
