...
<script language="javascript" type="text/javascript">
    $(function(){
        ...
        $("#num_add").click(function(){
            $.ajax(
                {
                    type: "POST",
                    url: "index.php?action=Kucun&mode=addOutStorageNum",
                    ...
                    success: function(msg)
                    {
                        if (msg.code =='1000'){
                            if (confirm("保存成功，继续添加？")){
                                ...
                                location.href = "index.php?action=Kucun&mode=toOutStorageList";
                            }
                        }
                    }
                }
    ...
    function sortPro() {
        location.href = "index.php?action=Kucun&mode=toOutStorageList&proNo="
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" action="index.php?action=Kucun&mode=toOutStorageList" enctype="multipart/form-data" name="basic_validate" id="basic_validate" novalidate="novalidate">
                                    ...
                                    <span class="pull-left">
                                        ...
                                        <div class="controls">
                                            <select id="proSort" onchange="sortPro()" >
                                                ...
                                                <option value = "2" <?php if($order ==2) echo "selected" ?>>出库小计</option>
                            ...
                            <div class="form-actions">
                                <div class="control-group">
                                    ...
                                    <span class="pull-left">
                                        <label class="control-label">出库月份：</label>
                                        <div class="controls">
                                            ...
                                            <input type="submit" value="查询出库列表" class="btn btn-success"/>
                                        </div>
