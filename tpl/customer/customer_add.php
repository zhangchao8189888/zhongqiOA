            ...
            <div class="widget-content nopadding">
                <form action="index.php?action=Customer&mode=addCustomer" id="customer_validate" method="post" class="form-horizontal" novalidate="novalidate">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="customer_name" id="customer_name" class="span11" placeholder="客户名称">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label"><em style="color: red;padding-right: 10px;">*</em>客户编码 :</label>
                        <div class="controls">
                            <input type="text" name="customer_code" id="customer_code" class="span11" placeholder="客户编码">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="customer_address" id="customer_address" class="span11" placeholder="详细地址">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="customer_name" id="customer_realName" class="span6">
                            </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">座机</label>
                        <div class="controls">
                            <input type="text" name="customer_phone" id="customer_phone" class="span6">
                            </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">手机</label>
                        <div class="controls">
                            <input type="text" name="customer_mobile" id="customer_mobile" class="span6">
                            </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">QQ</label>
                        <div class="controls">
                            <input type="text" name="customer_qq" id="customer_qq" class="span6">
                            </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">email</label>
                        <div class="controls">
                            <input type="text" name="customer_email" id="customer_email" class="span6">
                            </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">微信</label>
                        <div class="controls">
                            <input type="text" name="customer_weixin" id="customer_weixin" class="span6">
                            </div>
                    </div>
                    <div class="control-group control-group-line">
                        ...
                        <div class="control-input">
                            <input type="text" id="birthday" name="birthday" value=""   onFocus="WdatePicker({onpicking: changeDate,isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd',realDateFmt:'yyyy-MM-dd'})"/>
                        </div>
                        <div class="control-label control-label-2">
                            <span>农历</span>
                        </div>
                        <div class="control-input">
                            <input type="text" value="" name="nongli" id="nongli" readonly="readonly" >
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">备注信息</label>
                        <div class="controls">
                            <textarea name="customer_more" id="customer_more" class="span11"></textarea>
                        </div>
                    </div>
